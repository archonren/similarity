...
def main(key,k,model_path,user_data_path,patch_path,verbosity):
    x = data(k,model_path,user_data_path,patch_path,verbosity)
    x.output(key)
...
if __name__ == '__main__':
    ...
    for user in args.keys:
        print('for %s'% user)
        main(user,args.k,args.model_path,args.user_data_path,args.patch_path,args.verbosity)
